    ...
    <>
      <div className="searcherContainer">
        <div className="searchBarContainer">
          <div className="searchBar yellow_alert">
            <input type="text" id="input" /* placeholder="Buscar alertas amarillas" */ onChange={(e) => debounceRes(e.target.value)}></input>
...
export default Searcher_yellow